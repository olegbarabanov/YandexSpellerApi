...
API для использования Яндекс.Спеллер
...
## Как использовать?
Мы имеем два метода проверки текста на орфографию `checkText` и `checkTexts`, т.е. проверить одно слово либо целое предложение.
